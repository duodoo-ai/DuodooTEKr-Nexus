...
data = {    # 对接应用方主动将用户数据增量同步到印管平台中
    "appKey": appKey,   # 应用标识，接入的应用系统身份标识,由印管平台提供
    "apiKey": "YXYG01_08",   # 接口标识，详细接口标识请参见接口标识
    ...
    "params": "[{'id':'1000110001','name':'张三','deptId':'21','login':'zhangsan','phone':'18844679921'}]"
}
print(data)
