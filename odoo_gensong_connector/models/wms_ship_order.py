...
class WmsShipOrder(models.Model):
    ...
    def Data_STK_TransferDirect_BillQuery(self, **kwargs):
        ...
        para = {
            ...
            "FieldKeys": "FBILLNO, FBillEntry_FSEQ, FBillEntry_FEntryID, FOBJECTTYPEID, FMATERIALID, FUNITID, FSrcStockID, FDestStockID, FQty, FLOT, FLOT_TEXT, FDOCUMENTSTATUS, FCANCELSTATUS",
        ...
        if len(res) > 0:
            for line in res:  # 遍历写入数据
                ...
                stock_out_record = stock_out_obj.search([('TMBillNo', '=', line['FBILLNO']),
                                                         ('FEntryID', '=', line['FBillEntry.FEntryID'])])
                pv = {
                    'TMBillNo': line['FBILLNO'],
                    'Order': line['FBillEntry.FSEQ'], # 由于云星空接口限制，取不到行号，用料号去唯一标识行号（同一张单据行料号不能出现重复情况）
                    'FEntryID': line['FBillEntry.FEntryID'],
    ...
    def Data_PRD_PickMtrl_BillQuery(self, **kwargs):
        ...
        para = {
            "FormId": "PRD_PickMtrl",
            "FieldKeys": "FBILLNO, FEntity_FSEQ, FEntity_FEntryID, FFORMID, FMATERIALID, FUNITID, FSTOCKID, FENTRYWORKSHOPID, FACTUALQTY, FLOT, FLOT_TEXT, FDOCUMENTSTATUS, FCANCELSTATUS",
            "FilterString": "'FBILLNO'=""",
            "OrderString": "",
            "TopRowCount": 1000,
            "StartRow": 0,
    ...
    def Data_SP_PickMtrl_BillQuery(self, **kwargs):
        ...
        para = {
            "FormId": "SP_PickMtrl",
            "FieldKeys": "FBILLNO, FEntity_FSEQ, FEntity_FEntryID, FFORMID, FMATERIALID, FUNITID, FSTOCKID, FWORKSHOPID, FACTUALQTY, FLOT, FLOT_TEXT, FDOCUMENTSTATUS, FCANCELSTATUS",
            "FilterString": "'FBILLNO'=""",
            "OrderString": "",
            "TopRowCount": 1000,
            "StartRow": 0,
    ...
    def Data_Stk_MisDelivery_BillQuery(self, **kwargs):
        ...
        para = {
            ...
            "FieldKeys": "FBILLNO, FEntity_FSEQ, FEntity_FEntryID, FOBJECTTYPEID, FMATERIALID, FUNITID, FSTOCKID, FQTY, FLOT, FLOT_TEXT, FDOCUMENTSTATUS, FCANCELSTATUS",
            "FilterString": "'FBILLNO'=""",
            "OrderString": "",
            "TopRowCount": 1000,
            "StartRow": 0,
